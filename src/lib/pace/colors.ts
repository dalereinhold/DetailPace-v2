import type { VehicleCondition, VehicleServiceType, VehicleType } from "@/lib/supabase"
...
export const FALLBACK_BADGE_COLOR = "text-muted-foreground bg-muted border-border"
